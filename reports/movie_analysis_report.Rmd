...
## Evaluation - Cycle 1
### Key Findings
- Number of movie releases increased from 9,066 in 2000 to a maximum of 47,190 in 2023 and then to 35,618 in 2024.
- Average rating declined from 2.47 in 2000 to 0.50 in 2024; however, this trend may be due to an increasing number   of lower-quality movies that received lower ratings.
- Annual average income varies throughout the period but demonstrates a negative trend, with a significant decline    after 2019 and partial recovery afterwards.
- Budget and income are highly correlated (0.72), meaning that the movies with higher budget are also generating      higher incomes.
- The vote count is highly correlated with income and budget while vote_average is poorly correlated with both of     these factors – high rating does not mean high income.

### Link to Success Criteria

These findings bear immediate relevance to the success criteria established in the Business Understanding. It was discovered that there is a stable and clear pattern between budget and revenue (correlation of 0.72), thus meeting the first success criterion. It was also made evident what the relationship between rating and revenue is – the lack of any significant correlation, meaning that they can be considered separate indicators of success, thus satisfying the second success criterion. However, in order to give some specific recommendations regarding acquisitions, further analysis should be conducted (Cycle 2).
