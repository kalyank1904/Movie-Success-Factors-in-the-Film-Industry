...
The merged data consists of about `r format(nrow(movies), big.mark=",")` rows and `r ncol(movies)` columns, indicating a huge dataset, making it effective to gain a clear understanding of the data pattern.
